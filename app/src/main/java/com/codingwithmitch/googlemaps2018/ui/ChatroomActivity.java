        ...
        View.OnClickListener
{
    ...
    private ArrayList<UserLocation> mUserLocation = new ArrayList<>();        //creating a list of user location.
                ...
                .addSnapshotListener(new EventListener<QuerySnapshot>() {
                    ...
                    public void onEvent(@javax.annotation.Nullable QuerySnapshot queryDocumentSnapshots, @javax.annotation.Nullable FirebaseFirestoreException e) {
                        ...
                        if(queryDocumentSnapshots != null){
                            ...
                            for (QueryDocumentSnapshot doc : queryDocumentSnapshots) {   //looping to all the users in a chatroom & adding them in a userlist.
                                User user = doc.toObject(User.class);
                                mUserList.add(user);
                                getUserLocation(user);                         //      //looping to all the users location in a chatroom
                            }
    ...
    // Here we retrieve geopoint of users.
    ...
    private void inflateUserListFragment(){
        ...
        Bundle bundle = new Bundle();
         bundle.putParcelableArrayList(getString(R.string.intent_user_list), mUserList); // attaching userlists to bundle.

        bundle.putParcelableArrayList(getString(R.string.intent_user_locations), mUserLocation);      //                                                                        // now passing those retrieved locations in the fragments.
